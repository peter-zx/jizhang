...
router.put('/settings', authMiddleware, authController.updateDistributorSettings);
router.post('/unlock-settings', authMiddleware, adminOnly, authController.unlockDistributorSettings);
